...
$url = "http://project-sec.hol.es/product-versions.json";
$ch  = curl_init();
...
<a href="http://codecanyon.net/item/project-security-website-security-malware-vulnerability-scanner/15487703?ref=Antonov_WEB" title="Download the Update" target="_blank" class="btn btn-flat btn-success btn-lg">
