...
function Whois($site)
{
    ...
    $url       = 'http://www.whois-search.com/whois/' . clean_url($site);
    @$options = array(
        'http' => array(
            'method' => "GET",
    ...
    $string1 = explode('<pre>', $content);
    @$string2 = explode("</pre>", $string1[1]);
    
    $whois_data = $string2[0];
    return $whois_data;
}
...
?> sec</span></h4></td>
                                                    ...
                                                    <tr>
														...
														<td><h4><span class="label label-warning">0</span></h4></td>
													</tr>
                                                    <tr>
														<td>Alexa Rank</td>
