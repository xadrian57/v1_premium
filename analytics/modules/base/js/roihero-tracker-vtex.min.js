...
RoiHero.tagflag.Init = function(page) {
            ...
            .done(function(orderForm) {
                ...
                vtexjs.checkout.addToCart(item, null, 1)
                  .done(function(orderForm) {
                    ...
                    // CRIAÇÃO DE COOKIE COM O ID
                    RoiHero.cookie.set("rh_rec_id", rh_rec_id, [0,1,0,0], "/");

                    // AJAX PARA SETAR OPEN
                    RoiHero.ajax.post(
                            'https://re.roihero.com.br/recuperacao_boleto.php',
                            'rh_rec_id=' + rh_rec_id,
                            // Success
                            function(data)
                            {
	...
	RoiHero.track.transaction = function() {
        ...
        var idWidget = RoiHero.util.getWidgetId(idProd);
        var transactionId = RoiHero.transaction.getQuantity();  // quantity_id
        var price = RoiHero.transaction.getPrice();             // values_id
        var quantity = RoiHero.transaction.getTransactionId();  // transaction_id
        ...
        if(rh_rec_id != '')
        {
            ...
            {
                valueTotal = valueTotal + (price[i] * quantity[i]);
            }
