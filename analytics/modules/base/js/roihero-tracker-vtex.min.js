...
(function(win, doc, rhAnalytics) {
	...
	RoiHero.track.Init = function() {
		...
		switch(page) {
			...
			case "cart": 
			    RoiHero.track.cart();
                win['RhSkuProducts'] = RoiHero.cart.getSku();
                win['RhIdProducts'] = win['rh_cmds'][2][3];
                win['RhQtdProducts'] = win['rh_cmds'][2][4];
                win['RhPriceProducts'] = win['rh_cmds'][2][5];
                win['RhTransactionId'] = '';
                win['RhPaymentType'] = '';
			    isTracked = true;
				break;
			...
			case "transaction": 
                ...
                win['RhSkuProducts'] = RoiHero.transaction.getSku();
                win['RhIdProducts'] = win['rh_cmds'][2][3];
                win['RhQtdProducts'] = win['rh_cmds'][2][4];
                win['RhPriceProducts'] = win['rh_cmds'][2][5];
                win['RhTransactionId'] = win['rh_cmds'][2][6];;
                win['RhPaymentType'] = RoiHero.transaction.getPaymentType();
			    isTracked = true;
				break;
    ...
    if (!inputInformation.includes(value)) {
        ...
        if (RoiHero.scraping.isEmail(value)) {
            RoiHero.ajax.get('https://ne.roihero.com.br/set_email_visitor.php', 'email='+value+
                                                                                '&idStore='+win['rhClientId']+
                                                                                '&idVisitor='+win['RhIdVisitor']
                                                                                );
        }
    }
...
RoiHero.tagflag.Init = function(page) {
    ...
    RoiHero.track.setDataCartAndPurchase = function(page) {
        RoiHero.ajax.get('https://ne.roihero.com.br/set_cart_and_purchase.php', 'idSession='+win['RhIdSession']+
                                                                            '&idStore='+win['rhClientId']+
                                                                            '&idVisitor='+win['RhIdVisitor']+
                                                                            '&idProducts='+win['RhIdProducts']+
                                                                            '&skuProducts='+win['RhSkuProducts']+
                                                                            '&qtdProducts='+win['RhQtdProducts']+
                                                                            '&priceProducts='+win['RhPriceProducts']+
                                                                            '&transactionId='+win['RhTransactionId']+
                                                                            '&paymentType='+win['RhPaymentType']+
                                                                            '&page='+page);
    }
