...
RoiHero.tagflag.Init = function(page) {
	...
	RoiHero.util.getPage = function() {
        ...
        if (typeof dataLayer == "object") {
            for(var j = 0; j < dataLayer.length; j++){
                for(var i = 0; i < dataLayer[j].length; i++){
                    if (dataLayer[j][i].content_type == "product") 
                    {                   
                        return "product";                        
                    }
                    else if(dataLayer[j][i] == "conversion")
                    {
                        return "transaction";
                    }
                }
	...
	RoiHero.util.verificarDataLayer = function(numTentativas) {
        ...
        if(dataLayer.length < 8 && numTentativas < numMaxTentativas) {
