...
(function(win, doc, rhAnalytics) {
	...
	RoiHero.util.getPage = function() {
	    ...
	    if(gtm && gtm.page) {
	    	...
	    	else if(gtm.page == 'showcase') {
	    		if(gtm.filters && gtm.filters.category) {
	    			pageType = 'category';
	    		}
	    		else {
	    			pageType = "search";
	    	...
	    	else if(gtm.page == 'product') {
	    		pageType = 'product';
	    	}
	    	else if(gtm.page == 'cart') {
	    		pageType = 'cart';
	    	}
	    	else if(gtm.page == 'confirmation') {
	...
	RoiHero.util.getCategory = function() {
		...
		for (var i = 0; i < gtm.filters.category.length; i++) {
			
			if(i > 0) {
				cat += ' - ';
			}
			
			cat += gtm.filters.category[i];
		}
	...
	RoiHero.product.getId = function() {
		var gtm = win['gtm'];
	    var prds = gtm.product;
	    
	    if(gtm.product && gtm.product.id) {
	    	return gtm.product.id.toString();
	    } 
	...
	RoiHero.product.getPrice = function() {
	    ...
	    if(gtm.product && gtm.product.price_number) {
	    	return gtm.product.price_number.toString();
	    } 
