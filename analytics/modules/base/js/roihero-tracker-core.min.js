...
RoiHero.tagflag.Init = function(page) {
	...
	RoiHero.util.getPage = function() {
	    ...
	    else if (dataLayer[0].pageCategory == "cart") {
	        pageType = "cart";
	    }
	    else if (dataLayer[0].pageCategory == "checkout") {
	...
	RoiHero.product.getId = function() {
		var idProd = '';
	    var items = dataLayer[1].ecommerce.detail.products;
	...
	RoiHero.util.getCartProducts = function() {
		var dataLayer = win['dataLayer'];
		for(var i = 0; i < dataLayer.length; i++) {
			if(dataLayer[i].ecommerce && dataLayer[i].ecommerce.add && dataLayer[i].ecommerce.add.products) {
				return dataLayer[i].ecommerce.add.products;
			}
		}
	...
	RoiHero.util.transactionProducts = function() {
		...
		for(var i = 0; i < dataLayer.length; i++) {
			...
			if(dataLayer[i].ecommerce && dataLayer[i].ecommerce.checkout && dataLayer[i].ecommerce.checkout.products) {
