...
RoiHero.tagflag.Init = function(page) {
	...
	RoiHero.transaction.getId = function () {      
        ...
        dataLayer.forEach(function(value, key) {
            if(value.event == "orderPlaced")
            {
                items = value.transactionProducts;
                break;
            }
        });
	...
	RoiHero.transaction.getTransactionId = function() {
        ...
        dataLayer.forEach(function(value, key) {
            if(value.event == "orderPlaced")
            {
                idTransacao = value.transactionId;
                break;
            }
        });
	...
	RoiHero.util.getPage = function() {
        ...
        if (typeof dataLayer == "object") {
            for(var j = 0; j < dataLayer.length; j++){
                if (dataLayer[j].pageTemplate == "Homepage") 
                {                   
                    return "home";                        
                }
                else if (dataLayer[j].pageTemplate == "Product") 
                {                   
                    return "product";                        
                }
                else if (dataLayer[j].pageTemplate == "Category") 
                {                   
                    return "category";                        
                }
                else if (dataLayer[j].pageTemplate == "View_cart") 
                {                   
                    return "cart";                        
                }
                else if (dataLayer[j].pageTemplate == "Order_Placed") 
                {                   
                    return "transaction";                        
                }
                else if (dataLayer[j].pageTemplate == "Search") 
                {                   
                    return "search";                        
                }
            }
	...
	RoiHero.util.getCategory = function() {
        ...
        var dataLayer = win['dataLayer'];
         ...
         if (typeof dataLayer == "object") {
            for(var j = 0; j < dataLayer.length; j++){                
                if(dataLayer[j].pageTemplate == "Category")
                {
                    category = dataLayer[j].pageCategory;
                    break
                }
            }
        }
