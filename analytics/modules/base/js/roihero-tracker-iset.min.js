...
(function(win, doc, rhAnalytics) {
	...
	RoiHero.transaction.getTransactionId = function() {
		return win['rh_data'].idTransaction;
	};
	
	RoiHero.transaction.getPrice = function() {
		var products = win['rh_data'].product;
		var prices = '';
	...
	RoiHero.util.getPage = function() {
		...
		var pageType = 'unknow';
	    var rhData = win['rh_data'];
	    
	    if(rhData) {
	    	if (rhData.event == "PageHome") {
	    		pageType = "home";
	    	}
	    	else if (rhData.event == "PageProduct") {
	    		pageType = "product";
	    	}
	    	else if (rhData.event == "PageCart") {
	    		pageType = "cart";
	    	}
	    	else if (rhData.event == "PagePurchase") {
	    		pageType = "transaction";
	    	}
	    	else if (rhData.event == "PageCategory") {
	    		pageType = "category";
	    	}
	    }
	...
	RoiHero.util.getCategory = function() {
		return win['rh_data'].categoryName;
	};
