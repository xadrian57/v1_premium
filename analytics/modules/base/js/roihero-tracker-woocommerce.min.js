...
(function(win, doc, rhAnalytics) {
	...
	RoiHero.transaction.getId = function () {
		var ids = '';
        var items = win['rhDataLayer'].items;
	...
	RoiHero.transaction.getTransactionId = function() {
		return win['rhDataLayer'].transactionId;
	};

	RoiHero.util.getPage = function() {
	    var pageType = "unknown";
	    	
    	if ("product" == win['rhDataLayer'].page) {
    		pageType = "product";
    	}
	    else if ("cart" == win['rhDataLayer'].page) {
	        pageType = "cart";
	    }
	    else if ("category" == win['rhDataLayer'].page) {
	        pageType = "category";
	    }
	    else if ("checkout" == win['rhDataLayer'].page) {
	...
	RoiHero.product.getId = function() {
		return win['rhDataLayer'].productId.toString();
	};

	RoiHero.product.getPrice = function() {
		return win['rhDataLayer'].price;
	};
    ...
    RoiHero.cart.getId = function() {
        var idsProd = '';
        var items = win['rhDataLayer'].cart;
