...
(function(win, doc, rhAnalytics) {
	...
	RoiHero.transaction.getTransactionId = function() {
		return win['rhData'].idTransaction;
	};
	
	RoiHero.transaction.getPrice = function() {
		var products = win['rhData'].products;
		var prices = '';
	...
	RoiHero.util.getPage = function() {
		...
		var pageType = 'unknow';
	    var rhData = win['rhData'];

	    if(rhData) {
	    	if (rhData.eventPage == "home") {
	    		pageType = "home";
	    	}
	    	else if (rhData.eventPage == "product") {
	    		pageType = "product";
	    	}
	    	else if (rhData.eventPage == "cart") {
	    		pageType = "cart";
	    	}
	    	else if (rhData.eventPage == "purchase") {
	    		pageType = "transaction";
	    	}
	    	else if (rhData.eventPage == "category") {
	    		pageType = "category";
	    	}
	    }
	...
	RoiHero.util.getCategory = function() {
		return win['rhData'].categoryName;
	};
    ...
    RoiHero.widget.injectWidget = function(item) {
        ...
        // Checa se existe o evento
        if (typeof RoiHero.widget.onload !== 'undefined') {
            // chama a função e passa como parâmetro o obj do widget que foi carregado
            RoiHero.widget.onload({
                'container': (item.inject_type == 'id') ? '#rhtf_'+item.inject_name : '.rhtf_'+item.inject_name, // seletor da div que segura o bloco
                'html': item.html, // html do bloco
                'el': objNew // DOM do bloco
            });
        }
